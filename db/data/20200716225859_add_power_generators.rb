class AddPowerGenerators < SeedMigration::Migration
  def up
    SeedMigration.register PowerGenerator
    
    # Import list the Power Generators
    powergenerator = { name: 'TRIFÁSICO 380V', 
    ...
    powergenerator[:chargeable_weight] = powergenerator[:height]*powergenerator[:width]*powergenerator[:lenght]*300
    PowerGenerator.create!(powergenerator)
